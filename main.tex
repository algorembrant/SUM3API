...
All metadata are fetched automatically, independent of the ticker or symbol attached to the Expert Advisor. For this implementation, the EA can be attached to any chart (e.g., XAUUSDc or BTCUSDc) without modifying the code\label{ref:a1}\textsuperscript{\hyperref[sec:a1]{A1}}.
...
The methodology enabled several practical applications\label{ref:a4}\textsuperscript{\hyperref[sec:a4]{A4}}:
...
\begin{enumerate}
    ...
    \item Open-source implementation enabling reproducibility and extension\label{ref:a6}\textsuperscript{\hyperref[sec:a6]{A6}}
\end{enumerate}
