...
All source code, markdown libraries, documentations, and examples are available under an MIT open-source license at:
...
The core dependencies for the MQL5 integration, \texttt{libzmq} and \texttt{libsodium}, are open-source libraries available for download from their official repositories. \texttt{libzmq} can be obtained from \url{https://zeromq.org}, and \texttt{libsodium} is available at \url{https://libsodium.org}. Users should ensure they download the versions compatible with their operating system architecture (typically 64-bit for modern MT5 installations).
