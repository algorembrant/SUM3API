...
\begin{IEEEkeywords}
MetaTrader 5, ZeroMQ, Rust, MQL5, algorithmic trading, inter-process communication, financial data extraction, low-latency systems
\end{IEEEkeywords}
...
The MQL5 implementation totals approximately 600 lines of code across two files: the \texttt{Zmq.mqh} wrapper (144 lines) and the \texttt{ZmqPublisher.mq5} Expert Advisor.
...
The system was validated through integration testing within a live MT5 environment connected to a demo trading account. Validation criteria included:
